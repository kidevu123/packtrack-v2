...
def _render_item_detail(
    ...
    *,
    ...
    # v2.11.0 stock-ownership variance (PackTrack - Zoho snapshot). Surfaced
    # by the Stock card on the item detail page; does NOT alter operational
    # behavior. The v2.12.0 master-data editor does not touch this value.
